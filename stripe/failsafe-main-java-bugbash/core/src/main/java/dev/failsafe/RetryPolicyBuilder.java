...
public class RetryPolicyBuilder<R> extends DelayablePolicyBuilder<RetryPolicyBuilder<R>, RetryPolicyConfig<R>, R>
  ...
  public RetryPolicyBuilder<R> abortIf(CheckedPredicate<R> resultPredicate) {
    ...
    config.abortConditions.add(delegatedFailOnMatchingResult(resultPredicate));
    return this;
  }
  ...
  public RetryPolicyBuilder<R> abortOn(List<Class<? extends Throwable>> exceptions) {
    ...
    config.abortConditions.add(throwablePredicateForMultipleThrowables(exceptions));
    return this;
  }
  ...
  public RetryPolicyBuilder<R> abortOn(CheckedPredicate<? extends Throwable> abortPredicate) {
    ...
    config.abortConditions.add(failOnMatchingThrowable(abortPredicate));
    return this;
  }
  ...
  public RetryPolicyBuilder<R> abortWhen(R result) {
    config.abortConditions.add(failOnMatchingExecutionResult(result));
    return this;
  }
